...
I don't believe IoT, social media and LLMs make the lives of the majority of people better by any stretch, neither do they make a good impact on the environment (only worse, if anything, by consuming massive amounts of electricity on something that is definitely not helpful or important for humanity).
...
In my mind the list should be first reduced to only list actually important inventions:

25. 3D printing
24. ~~Birth control patch~~ (not a breaktrhough, just another option)
23. ~~Humanoid robots~~ (no real value, just different form factor)
22. Capsule endoscopy
21. ~~Blockchain Technology~~ (useless for all cases and scenarios)
20. ~~Subscription video on-demand dervices~~ (money grab, useless for anyone except investors)
19. ~~Smart home services~~ (useless for most, mostly money grab)
18. Artificial organs
17. ~~Smart energy grids~~ (only useful for energy companies)
...
10. Reusable rockets
9. GPS navigation
8. ~~Cloud computing~~ (only useful for investors and big players)
...
3. ~~Social media~~
2. Smartphones
1. ~~Transformer LLM architecture~~

And in my humble opinion the ranking should also shift quite a bit, but that would depend on a plethora of criteria, so for instance the tech for convenience (5G, GPS, autonomus vehicles and birth control patches) vs breakthrough (capsule endoscopy, quantum computing, hydrogen fuel cells) or how refined the technology is (GSP vs quantum computing) or how many people does it affect (smartphones vs reusable rockets).
