...
But there are much more interesting things which were invented on this wave of FP popularity. One of them is [Elm](http://elm-lang.org/). It is ML-like language, which compiles to JS **plus** a runtime.
