...
<div class="row">
    ...
    <div class="col-md-6 col-xs-12 text-xs-center text-md-right">
        <img data-src="{{ '/images/two-sides-of-web-application/a305-1-compressed.jpg' | prepend: site.baseurl }}" class="img-responsive" style="max-height: 150px" alt="Funny image" />
    </div>
</div>
