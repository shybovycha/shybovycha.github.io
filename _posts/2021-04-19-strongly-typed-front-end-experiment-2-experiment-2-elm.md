...
tags: [reasonml, javascript, fsharp, typescript, type-safety, fp, haskell, dotnet, frontend, functional-programming]
---
...
3. Experiment 2, simple application
    - [**Elm (you are here)**](/2021/04/19/strongly-typed-front-end-experiment-2-experiment-2-elm.html)
