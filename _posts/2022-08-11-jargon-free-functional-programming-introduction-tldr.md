...
This is a boiled-down version of a much longer read, _Jargon-free functional programming_ (coming soon),
...
The next article (coming soon) contains a few examples and explains the above in bloody details,
