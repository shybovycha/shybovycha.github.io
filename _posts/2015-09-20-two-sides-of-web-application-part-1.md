...
<div class="row" style="justify-content: space-between">
    ...
    <div class="col-md-6 col-xs-12 text-xs-center text-md-right">
        <img data-src="/images/two-sides-of-web-application/chocolate_tools.webp" class="img-responsive" style="max-height: 150px" />
    </div>
</div>
...
<div class="text-center">
    <img data-src="/images/two-sides-of-web-application/general_architecture.webp" class="img-responsive" />
</div>
