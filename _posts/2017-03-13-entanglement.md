...
<img data-src="/images/entanglement/ios-screen1_optimized.webp" {% imagesize "/images/entanglement/ios-screen1_optimized.webp":props %} alt="">

# Entanglement?

Some time ago there was a game popular over there, called Entanglement:

<img data-src="/images/entanglement/web-screen1.webp" {% imagesize "/images/entanglement/web-screen1.webp":props %} alt="">
...
<div class="row">
    <div class="col">
        <img data-src="/images/entanglement/android-screen1.webp" {% imagesize "/images/entanglement/android-screen1.webp":props %} alt="">
    </div>
    <div class="col">
        <img data-src="/images/entanglement/android-screen2.webp" {% imagesize "/images/entanglement/android-screen2.webp":props %} alt="">
    </div>
</div>
...
<img data-src="/images/entanglement/120-deg-coordinate-system.webp" {% imagesize "/images/entanglement/120-deg-coordinate-system.webp":props %} alt="">
...
<img data-src="/images/entanglement/tiles-1.webp" {% imagesize "/images/entanglement/tiles-1.webp":props %} alt="">
...
<img data-src="/images/entanglement/tile-connections-1.webp" {% imagesize "/images/entanglement/tile-connections-1.webp":props %} alt="">
...
<img data-src="/images/entanglement/tile-sample.webp" {% imagesize "/images/entanglement/tile-sample.webp":props %} alt="">
...
<img data-src="/images/entanglement/entanglement-tile-neighbours.webp" {% imagesize "/images/entanglement/entanglement-tile-neighbours.webp":props %} alt="">
...
<img data-src="/images/entanglement/score_equation.webp" {% imagesize "/images/entanglement/score_equation.webp":props %} alt="">

# The end result

The end result of this coding exercise looks like exactly as the one at the very top of this post:

<img data-src="/images/entanglement/ios-screen1.webp" {% imagesize "/images/entanglement/ios-screen1.webp":props %} alt="">
