...
<img data-src="{{ site.baseurl }}/images/irrlicht-newton-tutorials/blender/3.png" alt="Switching between edges, faces and vertices in edit mode" class="img-responsive">
